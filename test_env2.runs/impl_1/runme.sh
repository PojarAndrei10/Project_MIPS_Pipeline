...
HD_PWD='C:/Users/andre/test_env2/test_env2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_env2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_env2.tcl -notrace
