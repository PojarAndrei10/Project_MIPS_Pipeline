...
HD_PWD='C:/Users/andre/test_env2/test_env2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_env2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_env2.tcl
